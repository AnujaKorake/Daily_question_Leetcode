    ...
    def countGoodIntegers(self, n: int, k: int) -> int:
        ...
        for i in range(10**(n-1), 10**n):
            ...
            for p in set(permutations(digits)):
                ...
                if Solution.is_palindrome(new_str) and int(new_str)%k == 0:
                    count += 1
                    break
...
#***** The above code is simple but it leads to time limit exceeds error. *****
...
** the above code is as it is pasted :|) *** 
